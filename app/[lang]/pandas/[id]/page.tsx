  ...
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 md:py-12">
      ...
      <div className="card overflow-hidden mb-8">
        {/* Header bg */}
        <div className="h-32 md:h-40 bg-gradient-to-br from-bamboo-400 via-bamboo-500 to-bamboo-700 relative overflow-hidden">
          <div className="absolute inset-0 opacity-10">
            {[...Array(12)].map((_, i) => (
              <div key={i} className="text-2xl absolute"
                   style={{ left: `${5 + i * 8}%`, top: `${10 + (i % 3) * 30}%` }}>
                🎋
              </div>
            ))}
          </div>
        ...
        <div className="px-6 pb-6">
          <div className="flex flex-col items-center -mt-14 md:-mt-16">
            <div className="w-28 h-28 md:w-32 md:h-32 rounded-full bg-white dark:bg-panda-900 border-4 border-white dark:border-panda-700 shadow-lg
                            flex items-center justify-center overflow-hidden">
              <PandaAvatar data={panda} size={128} />
            </div>
          ...
          <div className="card p-5 md:p-6 mb-8">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
              {related.map(p => (
                ...
                >
                  {/* Avatar */}
                  <div className="w-20 h-20 rounded-full bg-bamboo-100 dark:bg-bamboo-900/40 flex items-center justify-center
                                  overflow-hidden group-hover:scale-110 transition-transform mb-3">
                    <PandaAvatar data={p} size={80} />
                  </div>
